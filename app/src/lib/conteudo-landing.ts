 ...
 *
 * Portado de `js/dados.js` do site estático. Fica separado dos componentes
 * para o texto poder vir de um CMS depois sem mexer no layout.
 */
...
export const servicos = [
  {
    ...
    texto:
      'Consolidação inteligente de cargas LTL com saídas diárias entre os principais eixos.',
  ...
  },
  {
    ...
    titulo: 'Armazenagem',
    texto:
      '9 centros próprios com WMS integrado, câmara fria e inventário cíclico auditado.',
    metrica: '142 mil m²',
    tom: '#DFF0E4',
  },
  {
    ...
    titulo: 'Last mile',
    texto:
      'Frota leve e parceiros homologados para entrega no mesmo dia em 18 capitais.',
    metrica: 'Same day',
    tom: '#D8EFEA',
  },
  {
    ...
    texto:
      'Time dedicado monitorando desvios de rota, temperatura e SLA 24 por 7.',
    metrica: '24/7 ativo',
    tom: '#E7F4DE',
  },
];
...
export const passos = [
  {
    ...
    titulo: 'Diagnóstico',
    texto:
      'Mapeamos volumes, rotas e gargalos da sua operação atual em uma semana.',
  },
  {
    n: 'PASSO 02',
    titulo: 'Desenho da malha',
    texto:
      'Propomos rotas, CDs e modais com custo por entrega aberto na planilha.',
  },
  {
    n: 'PASSO 03',
    titulo: 'Integração',
    texto:
      'Conectamos ERP e e-commerce via API ou EDI, sem trabalho do seu time.',
  },
  {
    n: 'PASSO 04',
    titulo: 'Operação viva',
    texto:
      'Painel em tempo real, comprovante digital e revisão mensal de indicadores.',
  },
];
...
const cargas: Record<string, Carga> = {
  'RV-88421': {
    codigo: 'RV-88421',
...
/** Normaliza o que o usuário digita: "rv 88421" → "RV-88421". */
...
export function buscarCarga(codigo: string): {
  ok: boolean;
  carga: Carga;
  solicitado: string;
} {
